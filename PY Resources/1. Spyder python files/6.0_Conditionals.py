...
##
#print('var_4 and var_5 < 100?',(var_4 and var_5) < 100)
#print('var_4 and var_5 < 22?',(var_4 and var_5) < 22)
#print('var_4 or var_5 < 22?',(var_4 or var_5) < 22, end = '\n\n')
#
#print('not True is:',not True)
#print('not False is:',not False, end = '\n\n')
#
#print('not(var_4 and var_5 < 100?)',not(var_4 and var_5 < 100))
#print('not(var_4 and var_5 < 22?)',not(var_4 and var_5 < 22))
#print('not(var_4 or var_5 < 22?)',not(var_4 or var_5 < 22))
